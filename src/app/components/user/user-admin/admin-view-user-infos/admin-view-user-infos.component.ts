...
import { CommonService } from '../../../../shared/common.service'; 7
...
export class AdminViewUserInfosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userService.getUserBuyUserId(this.userId)
      .subscribe(
        data => {
          this.user = data.user;
  ...
  validateProduct() {
    if (this.userForm.valid) {
      ...
      this.userService.updateUserInfo(this.product._id, this.user)
        .pipe(first())
        .subscribe(
          data => {
